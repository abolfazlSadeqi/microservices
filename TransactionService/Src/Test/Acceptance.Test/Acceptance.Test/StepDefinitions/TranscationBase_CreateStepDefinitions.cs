...
{
    [Binding]
    public class TranscationBase_CreateStepDefinitions
    {
        ...
        public TranscationBase_CreateStepDefinitions(ScenarioContext scenarioContext)
        {
        ...
        public void WhenICreateWithFull(Table table)
        {
            ...
            var listcustomers = table.CreateSet<CreateTranscationBaseCommand>();
        ...
        public void ThenCreateOfThisCustomersAreSuccessful()
        {
            ...
            var createdCustomer = _scenarioContext.Get<List<CreateTranscationBaseCommand>>("CreatedCustomer");
